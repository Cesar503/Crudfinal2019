package com.example.crudfinal2019;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Snackbar.make(view, "2019 Cesar Cruz", Snackbar.LENGTH_LONG)
    ...
    private void DialogConfirmacion2(){
        //startActivity(new Intent(getApplicationContext(),MainActivity.class));
        String mensaje2 = "Creado por Cesar Cruz";
        dialogo = new AlertDialog.Builder(MainActivity.this);
        ...
        dialogo.setNegativeButton("Volver", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogo, int id) {
                Toast.makeText(getApplicationContext(), "github.com/Cesar503", Toast.LENGTH_LONG).show();
            }
        });
        dialogo.show();
